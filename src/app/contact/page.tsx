		...
		<div className=' bg-white pt-32 '>
			...
			<div className=' lg:max-w-[690px] lg:px-0 md:px-[74px] px-4 mt-[100px]  mx-auto text-black text-center '>
				...
				<p className=' text-[#424242] lg:text-lg text-[16px] tracking-tight '>
					Need help? We are dedicated to providing exceptional customer service
					and are eager to assist you with any inquiries. Check our answers to
					the questions you have when you read our frequently asked questions.
				</p>
