    ...
    <>
      ...
      <body className='bg-white font-Albert_sans'>
        ...
        <div className='relative -mt-36 -z-10'>
          ...
          <Image src={Career_progress} alt='Career_progress' className='absolute lg:-mt-[42rem] md:-mt-[28rem] lg:w-[22rem] lg:ml-[48rem] z-[60] md:w-[12rem] md:ml-[26rem] xs:w-[12rem] xs:-mt-[21rem] xs:ml-[3.8rem]'/>
        ...
        <section>
          ...
          <div className='absolute lg:-mt-[54rem] md:-mt-[46rem] md:ml-[7rem] lg:ml-[10.5rem] xs:-mt-[50rem] z-30 xs:ml-[7rem] mx-[6rem]'>
            <p className='lg:text-5xl md:text-[1.8rem] xs:text-2xl xs:mt-24 xs:text-xl md:mt-[4rem] font-semibold xs:-ml-[5rem] lg:-mt-[7.5rem]'>Welcome to a World of <br/>Possibilities. <Image src={star_1} alt='star' className='inline'/></p>
            <h4 className='mt-4 md:text-sm xs:text-xs xs:-ml-[5rem] xs:text-[1.2rem]'>Come be a part of us!</h4>
            <div className='lg:mt-2 md:mt-10 xs:-ml-[6rem] md:w-[12rem] md:-ml-[3.9rem] xs:mt-7 lg:-ml-[4rem] xs:w-screen'><Button text="See Our Openings" /></div>
          </div>
        ...
        <main className='xs:mx-[6rem] lg:mx-[9rem] xs:-mt-7'>
          <section>
            <div>
              ...
              <p className='lg:w-[38rem] md:w-[42rem] xs:text-sm xs:-ml-[5rem] xs:w-[20rem] mt-5 '>
            ...
            <div className='mt-[8rem] xs:-ml-[6rem] md:w-screen xs:w-[18rem] md:w-screen'>
              <h2 className='lg:text-3xl text-3xl font-semibold xs:text-xl pb-5 lg:ml-[31rem] xs:ml-[7rem] md:ml-[17rem]'>Our openings</h2>
              <p className='text-center xs:text-sm xs:ml-4 xs:w-[20rem] xs:text-[14px] md:w-[30rem] md:mx-auto lg:mx-[4rem] lg:w-[32rem] lg:ml-[20rem]'>Find the perfect spot here at Noved Africa. We are working towards eradicating graduate unemployment in Africa, be a part of it.</p>
            </div>
          </section>
          <section className='mt-[6rem] lg:mx-[1rem] xs:-mx-[3rem]'>
            <div className='lg:flex bg-[#FAFAFA] xs:-mt-[2rem] xs:-ml-5 sm:pb-6 rounded-lg'>
          ...
          <div className='text-center md:ml-3 md:w-[28rem] lg:w-[32rem] lg:ml-[12rem] xs:w-[18rem] xs:text-sm xs:-ml-[3.6rem] my-[5rem] lg:mx-[5rem]'>
