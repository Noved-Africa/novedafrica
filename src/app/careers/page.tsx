   ...
   return (
    <>
      ...
      <body className='bg-white font-Albert_sans'>
        ...
        <section>
          <h5 className='text-sm absolute font-normal text-[#292929] lg:-mt-[64rem] md:-mt-[43rem] z-30 xs:-mt-[48rem] xs:ml-7 xs:text-xs mx-[6rem] lg:ml-[6rem]'>Careers at Noved Africa</h5>
          <div className='absolute lg:-mt-[54rem] md:-mt-[39rem] lg:ml-[10rem] xs:-mt-[42rem] z-30 mx-[6rem]'>
            ...
            <p className='lg:mt-2 md:mt-10 xs:-ml-[4rem] md:w-fit md:-ml-20 xs:mt-7 lg:-ml-[3rem] xs:w-[28rem]'><Button text="See Our Openings" /></p>
          </div>
        ...
        <main className='mx-[6rem] lg:mx-[9rem] md:mx-[6rem]'>
          <section>
            ...
            <div className='mt-[8rem]'>
              <h2 className='text-3xl font-semibold xs:ml-12 pb-5 lg:ml-[22rem] md:ml-[12rem]'>Our openings</h2>
              <p className='text-center lg:mx-[5rem]'>Find the perfect spot here at Noved Africa. We are working towards eradicating graduate unemployment in Africa, be a part of it.</p>
            </div>
          </section>
          ...
          <div className='text-center my-[5rem] lg:mx-[5rem]'>
