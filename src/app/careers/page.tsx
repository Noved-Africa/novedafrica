...
const Careers = () => {
   ...
   return (
    <>
      ...
      <body className='bg-[#ffffff] font-Albert_sans'>
        <Header/>
        <div className='relative -mt-36 -z-10'>
          ...
          <Image src={Career_progress} alt='Career_progress' className='absolute lg:-mt-[42rem] md:-mt-[27rem] lg:w-[22rem] lg:ml-[48rem] z-[60] md:w-[12rem] md:ml-[22rem] xs:w-[12rem] xs:-mt-[21rem] xs:ml-[5rem]'/>
          <Image src={group_five} alt='group_five' className='w-full -mt-32 md:-mt-25 md:h-[24rem] lg:h-[35rem] xs:h-[18rem]'/>
        </div>
        <section>
          <h5 className='text-sm absolute font-normal text-[#292929] lg:-mt-[72rem] md:ml-[2rem] md:-mt-[49rem] z-30 xs:-mt-[50rem] xs:ml-[1rem] xs:text-xs mx-[6rem] lg:ml-[6.5rem]'>Careers at Noved Africa</h5>
          <div className='absolute lg:-mt-[54rem] md:-mt-[46rem] md:ml-[7rem] lg:ml-[10.5rem] xs:-mt-[50rem] z-30 mx-[6rem]'>
            <p className='lg:text-5xl md:text-[1.8rem] xs:text-2xl xs:mt-24 font-semibold xs:-ml-[5rem] lg:-mt-[7.5rem]'>Welcome to a World of <br/>Possibilities. <Image src={star_1} alt='star' className='inline'/></p>
            <h4 className='mt-4 md:text-sm xs:text-xs xs:-ml-[5rem] xs:text-[1.2rem]'>Come be a part of us!</h4>
            <p className='lg:mt-2 md:mt-10 xs:-ml-[6rem] md:w-fit md:-ml-20 xs:mt-7 lg:-ml-[4rem] xs:w-[21rem]'><Button text="See Our Openings" /></p>
          </div>
        ...
        <main className='xs:mx-[6rem] lg:mx-[9rem] xs:-mt-7'>
          <section>
            ...
            <div className='mt-[8rem] xs:-ml-[6rem] xs:w-[18rem] md:w-screen'>
              ...
              <p className='text-center xs:text-sm xs:ml-4 xs:text-[14px] md:mx-[4rem] lg:mx-[24rem] lg:ml-[20rem]'>Find the perfect spot here at Noved Africa. We are working towards eradicating graduate unemployment in Africa, be a part of it.</p>
            </div>
          </section>
          ...
          <div className='text-center md:-ml-[3rem] md:w-[28rem] lg:w-[32rem] lg:ml-[12rem] xs:w-[16rem] xs:text-sm xs:-ml-[4rem] my-[5rem] lg:mx-[5rem]'>
