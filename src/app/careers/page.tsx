    ...
    <>
      ...
      <body className='bg-white font-Albert_sans'>
        ...
        <div className='relative -mt-36 -z-10'>
          <Image src={wave} alt='wavy background' className='w-screen h-[48rem] xs:h-[56rem] md:-mt-[15rem] lg:mt-[7rem]  relative z-20'/>
          <Image src={Career_progress} alt='Career_progress' className='absolute lg:-mt-[34rem] md:-mt-[26rem] lg:w-[22rem] lg:ml-[48rem] z-[60] md:w-[14rem] md:ml-[36rem] xs:w-[12rem] xs:-mt-[21rem] xs:ml-[5rem]'/>
          <Image src={group_five} alt='group_five' className='w-full -mt-32 md:-mt-25 md:h-[24rem] lg:h-[35rem] xs:h-[18rem]'/>
        </div>
        <section>
          <h5 className='text-sm absolute font-normal text-[#292929] lg:-mt-[64rem] md:-mt-[43rem] z-30 xs:-mt-[50rem] xs:ml-[1rem] xs:text-xs mx-[6rem] lg:ml-[6rem]'>Careers at Noved Africa</h5>
          <div className='absolute lg:-mt-[54rem] md:-mt-[39rem] lg:ml-[10rem] xs:-mt-[50rem] z-30 mx-[6rem]'>
            <p className='lg:text-5xl md:text-4xl xs:text-2xl xs:mt-24 font-semibold xs:-ml-[5rem]'>Welcome to a World of <br/>Possibilities. <Image src={star_1} alt='star' className='inline'/></p>
            <h4 className='mt-4 md:text-sm xs:text-xs xs:-ml-[5rem] xs:text-[1.2rem]'>Come be a part of us!</h4>
            <p className='lg:mt-2 md:mt-10 xs:-ml-[6rem] md:w-fit md:-ml-20 xs:mt-7 lg:-ml-[3rem] xs:w-[21rem]'><Button text="See Our Openings" /></p>
          </div>
        ...
        <main className='xs:mx-[6rem] lg:mx-[9rem] xs:-mt-7'>
          <section>
            <div>
              ...
              <p className='lg:w-[38rem] md:w-[42rem] xs:text-sm xs:w-[18rem] xs:-ml-[5rem] xs:mr-5 mt-5 '>
            ...
            <div className='mt-[8rem] xs:-ml-[6rem] xs:w-[18rem]'>
              <h2 className='text-3xl font-semibold xs:text-xl pb-5 lg:ml-[22rem] xs:ml-[6rem] md:ml-[12rem]'>Our openings</h2>
              <p className='text-center xs:text-sm xs:ml-4 xs:text-[14px] lg:mx-[5rem]'>Find the perfect spot here at Noved Africa. We are working towards eradicating graduate unemployment in Africa, be a part of it.</p>
            </div>
          </section>
          <section className='mt-[6rem] lg:mx-[1rem] xs:-mx-[3rem]'>
            <div className='lg:flex bg-[#FAFAFA] xs:-ml-5 sm:pb-6 rounded-lg'>
              <div className='p-7 xs:-ml-4 lg:mr-24 flex-auto lg:w-[34rem]'>
          ...
          <div className='text-center xs:w-[16rem] xs:text-sm xs:-ml-[4rem] my-[5rem] lg:mx-[5rem]'>
