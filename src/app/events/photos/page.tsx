  ...
  return(
    ...
    <body className='text-white font-Albert_sans '>
      ...
      <div className='mx-5 md:mt-80'>
        <p className='lg:text-5xl md:text-4xl text-center lg:ml-[10rem] md:ml-4 md:absolute md:mt-[8rem] lg:mt-[10rem] xs:absolute xs:pt-[8rem]'>Relive the moments, captured forever.</p>
        <p className='text-center xs:mt-[13rem] xs:absolute md:mx-10 md:ml-[2rem] md:absolute md:mt-[24rem] md:mb-[1rem] lg:absolute lg:mt-[24rem] xs:text-xs md:mx-[5rem] xs:mx-4 lg:ml-[10rem] md:text-lg lg:text-3xl '>Browse through our stunning event photos and immerse yourself <br/>in the memories that make our events truly unforgettable.</p>
...
{/* Mobile & Tablet Screen */}
      <div className='lg:collapse md:mt-[1rem] w-screen bg-[#FFFADE] md:absolute grid xs:grid-rows-2 xs:mb-12'>
        <form className='xs:mt-5 xs:grid xs:grid-cols-2'>
          <p><input type='text' placeholder='What are you looking for?' className='rounded-[3rem] border bg-white p-2 outline-none xs:pl-8 xs:text-sm xs:mt-2 xs:w-[9rem] md:w-[20rem] h-11 xs:h-8 xs:text-[8px] xs:ml-3'/>
