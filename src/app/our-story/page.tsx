    ...
    <>
      ...
      <body className="font-Albert_sans">
        ...
        <Image
          src={picnic}
          alt="Career growth"
          className="-z-10 lg:mt-0 w-screen xs:h-[30rem] md:h-[38rem] lg:h-[40rem]"
        />
        <div className="absolute xs:-mt-[24rem] md:-mt-[31rem] xs:mx-10 text-white lg:-mt-[34rem]">
          <p className="text-xs lg:ml-[4rem] lg:mt-[3rem]">Our Story</p>
          <h2 className="xs:mt-28 font-bold  lg:ml-[6rem] xs:text-[1.5rem] md:text-[2rem] text-center -ml-6">
            Your career growth, our
            <br className="xs:hidden md:visible" /> priority at Noved 
            <span className="xs:inline-block md:inline">Africa</span>
          </h2>
          <p className="text-center lg:ml-[18rem] xs:mt-4 xs:text-sm md:ml-[2rem] lg:w-1/2">
            All resources needed to help you grow career-wise and fit for business and global jobs are here. Stay
            connected, you are at the right place!
          </p>
          <p className="md:mx-[13rem] mx-auto md:mt-4 lg:ml-[31rem]">
            <Button text="About Noved Africa" />
          </p>
        </div>
        ...
        <section className="xs:mx-5 mt-20 font-Albert_sans lg:grid grid-cols-2 gap-[5rem]">
          <div className="lg:ml-20 lg:mt-14">
            ...
            <p className="xs:mt-5 lg:text-md">
              Noved Africa was born out of a burning desire to solve a single problem, unemployability. We are a team of
              strong-willed individuals dedicated to equipping undergraduates and fresh graduates with valuable employable
              skills.
            </p>
          </div>
        ...
        <section className="font-Albert_sans xs:mt-16 bg-[#F0EFFB] xs:py-12 ">
          <div>
            <p className="text-xl font-semibold text-center">Why Noved Africa?</p>
            <p className="text-center xs:pt-5 xs:pb-10 lg:w-1/2 xs:mx-6 lg:mx-auto">
              We deliver full spectrum resources to upskill students for employability purposes. Our services will help
              achieve becoming a job creator and becoming employable after graduation among other things.
            </p>
          </div>
          <div className="md:grid !md:grid-cols-2 lg:flex">
            <div className="mx-8 lg:-mr-10 md:grid md:grid-cols-2 flex-1 gap-0">
              <Image
                src={dart}
                alt="dart"
                className="rounded-t-xl md:rounded-r-none lg:h-[17rem] md:h-[18rem] xs:w-screen xs:h-[15rem]"
              />
              <div className="bg-[#E1E3EA] xs:pt-5 px-7 lg:h-[17rem] md:pb-24">
                ...
                <span className="text-sm pb-3">
                  We deliver full spectrum resources to upskill students for employability purposes.
                </span>
              </div>
            </div>
            <div className="mx-8 md:grid grid-cols-2 flex-1">
              <Image
                src={plane}
                alt="plane"
                className="xs:w-screen md:order-last lg:order-none lg:h-[17rem] xs:mx-auto xs:h-[15rem]"
              />
              <div className="bg-[#E1E3EA] lg:h-[17rem] md:h-[15rem] xs:pt-5 px-7  pb-10 rounded-b-lg">
                ...
                <span className="text-sm">
                  Our mission at Noved Africa is to empower African undergraduates and fresh graduates to become job-ready
                  talents, entrepreneurs, and leaders by providing the right education, resources, opportunities, support,
                  and platforms.
                </span>
              </div>
            </div>
        ...
        <section className="xs:mx-3">
          ...
          <div className="xs:mt-12 md:mx-6 lg:grid lg:grid-cols-2 gap-[2rem] place-content-center">
            ...
            <div className="bg-[#FCFDED] rounded-xl xs:px-6 py-7 mb-10 lg:-mt-[2rem]">
              ...
              <p>We are not just hard workers at Noved Africa, we’re also fun workers! We believe that work does not have to be boring; it’s okay to have a little fun. After all, all work and no play…</p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="text-center absolute mx-4 lg:mx-[20rem] xs:-mt-[22rem]">
            ...
            <p className="w-fit mx-auto xs:w-[10rem]"><Button text="Join the community ->" /></p>
          </div>
        </section>

        <section className="mt-14 mb-24 xs:ml-5 lg:ml-[5rem]">
          <h4 className="text-[#4A43CB]">OUR PARTNERS</h4>
          <p className="text-xl font-semibold">Organizations we have worked with to achieve our mission & vision.</p>
          <ImageGrid />
        </section>
      </body>
    </>
